...
Data customfield.NestedObjectList[PlanGroupsItemsDataSourceModel] `json:"data,computed"`
}
...
Items customfield.NestedObjectList[PlanGroupsItemsDataSourceModel] `tfsdk:"items"`
}
...
type PlanGroupsItemsDataSourceModel struct {
