...
var _ resource.ResourceWithConfigure = (*PlanGroupResource)(nil)
var _ resource.ResourceWithModifyPlan = (*PlanGroupResource)(nil)
var _ resource.ResourceWithImportState = (*PlanGroupResource)(nil)
...
func (r *PlanGroupResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	var data *PlanGroupModel = new(PlanGroupModel)
...
func (r *PlanGroupResource) ModifyPlan(_ context.Context, _ resource.ModifyPlanRequest, _ *resource.ModifyPlanResponse) {
