...
var _ resource.ResourceWithConfigure = (*IntegrationConfigurationResource)(nil)
var _ resource.ResourceWithModifyPlan = (*IntegrationConfigurationResource)(nil)
var _ resource.ResourceWithImportState = (*IntegrationConfigurationResource)(nil)
...
func (r *IntegrationConfigurationResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
  var data *IntegrationConfigurationModel
  ...
  params := m3ter.IntegrationConfigurationNewParams{
  ...
  _, err = r.client.IntegrationConfigurations.New(
    ctx,
    params,
...
func (r *IntegrationConfigurationResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
  ...
  res := new(http.Response)
  _, err = r.client.IntegrationConfigurations.Update(
    ctx,
    data.ID.ValueString(),
    params,
    option.WithRequestBody("application/json", dataBytes),
...
func (r *IntegrationConfigurationResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
  ...
  res := new(http.Response)
  _, err := r.client.IntegrationConfigurations.Get(
    ctx,
    data.ID.ValueString(),
    params,
    option.WithResponseBodyInto(&res),
...
func (r *IntegrationConfigurationResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
  ...
  params := m3ter.IntegrationConfigurationDeleteParams{
  ...
  _, err := r.client.IntegrationConfigurations.Delete(
    ctx,
    data.ID.ValueString(),
    params,
    option.WithMiddleware(logging.Middleware(ctx)),
...
func (r *IntegrationConfigurationResource) ModifyPlan(_ context.Context, _ resource.ModifyPlanRequest, _ *resource.ModifyPlanResponse) {
