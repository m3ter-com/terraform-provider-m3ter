...
type IntegrationConfigurationModel struct {
	...
	DestinationID            types.String                              `tfsdk:"destination_id" json:"destinationId,required,no_refresh"`
	...
	IntegrationCredentialsID types.String                              `tfsdk:"integration_credentials_id" json:"integrationCredentialsId,required,no_refresh"`
