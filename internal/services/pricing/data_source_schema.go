...
var _ datasource.DataSourceWithConfigValidators = (*PricingDataSource)(nil)
	...
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"pricing_bands": schema.ListNestedAttribute{
				Computed:   true,
				CustomType: customfield.NewNestedObjectListType[PricingPricingBandsDataSourceModel](ctx),
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						"fixed_price": schema.Float64Attribute{
							Description: "Fixed price charged for the Pricing band.",
