...
type PricingModel struct {
	...
	OveragePricingBands       customfield.NestedObjectList[PricingOveragePricingBandsModel] `tfsdk:"overage_pricing_bands" json:"overagePricingBands,computed_optional"`
