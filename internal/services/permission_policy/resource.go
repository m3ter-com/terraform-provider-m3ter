...
var _ resource.ResourceWithConfigure = (*PermissionPolicyResource)(nil)
var _ resource.ResourceWithModifyPlan = (*PermissionPolicyResource)(nil)
var _ resource.ResourceWithImportState = (*PermissionPolicyResource)(nil)
...
func (r *PermissionPolicyResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *PermissionPolicyModel
...
func (r *PermissionPolicyResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	var state *PermissionPolicyModel
...
func (r *PermissionPolicyResource) ModifyPlan(_ context.Context, _ resource.ModifyPlanRequest, _ *resource.ModifyPlanResponse) {
