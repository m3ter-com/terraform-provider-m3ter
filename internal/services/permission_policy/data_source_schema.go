...
var _ datasource.DataSourceWithConfigValidators = (*PermissionPolicyDataSource)(nil)
...
func (d *PermissionPolicyDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = DataSourceSchema(ctx)
}

func (d *PermissionPolicyDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
