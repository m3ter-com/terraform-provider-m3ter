...
type BillDataSourceModel struct {
	...
	CurrencyConversions      customfield.NestedObjectList[BillCurrencyConversionsDataSourceModel] `tfsdk:"currency_conversions" json:"currencyConversions,computed"`
	LineItems                customfield.NestedObjectList[BillLineItemsDataSourceModel]           `tfsdk:"line_items" json:"lineItems,computed"`
}
...
type BillCurrencyConversionsDataSourceModel struct {
...
type BillLineItemsDataSourceModel struct {
	...
	UsagePerPricingBand    customfield.NestedObjectList[BillLineItemsUsagePerPricingBandDataSourceModel] `tfsdk:"usage_per_pricing_band" json:"usagePerPricingBand,computed"`
}

type BillLineItemsUsagePerPricingBandDataSourceModel struct {
