...
type TransactionTypesDataListDataSourceEnvelope struct {
Data customfield.NestedObjectList[TransactionTypesItemsDataSourceModel] `json:"data,computed"`
}

type TransactionTypesDataSourceModel struct {
...
Items customfield.NestedObjectList[TransactionTypesItemsDataSourceModel] `tfsdk:"items"`
}

func (m *TransactionTypesDataSourceModel) toListParams(_ context.Context) (params m3ter.TransactionTypeListParams, diags diag.Diagnostics) {
  mCodes := []string{}
