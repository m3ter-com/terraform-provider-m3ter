...
func (d *CommitmentDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_commitment"
}

func (d *CommitmentDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *CommitmentDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *CommitmentDataSourceModel
	...
	if data.FindOneBy != nil {
		...
		env := CommitmentsDataListDataSourceEnvelope{}
		page, err := d.client.Commitments.List(ctx, params)
		if err != nil {
	...
	_, err := d.client.Commitments.Get(
		ctx,
		data.ID.ValueString(),
		params,
