	...
	return schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"fee_dates": schema.ListNestedAttribute{
				...
				Computed:    true,
				CustomType:  customfield.NewNestedObjectListType[CommitmentFeeDatesDataSourceModel](ctx),
...
func (d *CommitmentDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
