...
CurrencyConversions customfield.NestedObjectList[OrganizationConfigCurrencyConversionsModel] `tfsdk:"currency_conversions" json:"currencyConversions,computed_optional"`
