...
type BillJobDataSourceModel struct {
	...
	CurrencyConversions     customfield.NestedObjectList[BillJobCurrencyConversionsDataSourceModel] `tfsdk:"currency_conversions" json:"currencyConversions,computed"`
}
...
type BillJobCurrencyConversionsDataSourceModel struct {
