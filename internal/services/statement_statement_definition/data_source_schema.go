...
var _ datasource.DataSourceWithConfigValidators = (*StatementStatementDefinitionDataSource)(nil)
	...
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"dimensions": schema.ListNestedAttribute{
				...
				Computed:    true,
				CustomType:  customfield.NewNestedObjectListType[StatementStatementDefinitionDimensionsDataSourceModel](ctx),
			...
			"measures": schema.ListNestedAttribute{
				...
				Computed:    true,
				CustomType:  customfield.NewNestedObjectListType[StatementStatementDefinitionMeasuresDataSourceModel](ctx),
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
...
func (d *StatementStatementDefinitionDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = DataSourceSchema(ctx)
}

func (d *StatementStatementDefinitionDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
