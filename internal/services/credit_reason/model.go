...
func (m CreditReasonModel) MarshalJSON() (data []byte, err error) {
	return apijson.MarshalRoot(m)
}

func (m CreditReasonModel) MarshalJSONForUpdate(state CreditReasonModel) (data []byte, err error) {
