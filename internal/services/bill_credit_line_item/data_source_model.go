...
type BillCreditLineItemDataSourceModel struct {
...
func (m *BillCreditLineItemDataSourceModel) toReadParams(_ context.Context) (params m3ter.BillCreditLineItemGetParams, diags diag.Diagnostics) {
