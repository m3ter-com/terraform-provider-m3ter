...
type BillLineItemsDataListDataSourceEnvelope struct {
	Data customfield.NestedObjectList[BillLineItemsItemsDataSourceModel] `json:"data,computed"`
}

type BillLineItemsDataSourceModel struct {
	BillID   types.String                                                    `tfsdk:"bill_id" path:"billId,required"`
	OrgID    types.String                                                    `tfsdk:"org_id" path:"orgId,optional"`
	MaxItems types.Int64                                                     `tfsdk:"max_items"`
	Items    customfield.NestedObjectList[BillLineItemsItemsDataSourceModel] `tfsdk:"items"`
}

func (m *BillLineItemsDataSourceModel) toListParams(_ context.Context) (params m3ter.BillLineItemListParams, diags diag.Diagnostics) {
	params = m3ter.BillLineItemListParams{}
...
type BillLineItemsItemsDataSourceModel struct {
	...
	BandUsage              customfield.NestedObjectList[BillLineItemsBandUsageDataSourceModel] `tfsdk:"band_usage" json:"bandUsage,computed"`
...
type BillLineItemsBandUsageDataSourceModel struct {
