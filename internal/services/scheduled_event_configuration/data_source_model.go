...
type ScheduledEventConfigurationDataSourceModel struct {
	...
	FindOneBy *ScheduledEventConfigurationFindOneByDataSourceModel `tfsdk:"find_one_by"`
}
...
func (m *ScheduledEventConfigurationDataSourceModel) toListParams(_ context.Context) (params m3ter.ScheduledEventConfigurationListParams, diags diag.Diagnostics) {
...
type ScheduledEventConfigurationFindOneByDataSourceModel struct {
