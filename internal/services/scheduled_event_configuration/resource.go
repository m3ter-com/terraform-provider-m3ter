...
var _ resource.ResourceWithConfigure = (*ScheduledEventConfigurationResource)(nil)
var _ resource.ResourceWithModifyPlan = (*ScheduledEventConfigurationResource)(nil)
var _ resource.ResourceWithImportState = (*ScheduledEventConfigurationResource)(nil)
...
func (r *ScheduledEventConfigurationResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *ScheduledEventConfigurationModel
...
func (r *ScheduledEventConfigurationResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	var state *ScheduledEventConfigurationModel
...
func (r *ScheduledEventConfigurationResource) ModifyPlan(_ context.Context, _ resource.ModifyPlanRequest, _ *resource.ModifyPlanResponse) {
