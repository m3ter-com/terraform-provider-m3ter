...
var _ datasource.DataSourceWithConfigValidators = (*AggregationDataSource)(nil)
...
func (d *AggregationDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
