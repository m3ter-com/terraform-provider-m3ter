...
type BillDebitLineItemModel struct {
...
DebitReasonID types.String `tfsdk:"debit_reason_id" json:"debitReasonId,optional"`
...
func (m BillDebitLineItemModel) MarshalJSON() (data []byte, err error) {
  return apijson.MarshalRoot(m)
}

func (m BillDebitLineItemModel) MarshalJSONForUpdate(state BillDebitLineItemModel) (data []byte, err error) {
