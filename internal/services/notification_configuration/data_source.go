...
var _ datasource.DataSourceWithConfigure = (*NotificationConfigurationDataSource)(nil)

func NewNotificationConfigurationDataSource() datasource.DataSource {
	return &NotificationConfigurationDataSource{}
}

func (d *NotificationConfigurationDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
...
func (d *NotificationConfigurationDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *NotificationConfigurationDataSourceModel
	...
	_, err := d.client.NotificationConfigurations.Get(
		ctx,
		data.ID.ValueString(),
		params,
